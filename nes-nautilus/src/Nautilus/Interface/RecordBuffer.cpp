...
nautilus::val<uint64_t> RecordBuffer::getMemSize() const
{
    return {invoke(ProxyFunctions::NES_Memory_TupleBuffer_getMemSize, tupleBufferRef)};
}

void RecordBuffer::setMemSize(const nautilus::val<uint64_t>& memSize)
{
