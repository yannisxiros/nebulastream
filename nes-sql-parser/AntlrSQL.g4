...
DATA_TYPE: INTEGER_SIGNED_TYPE | INTEGER_UNSIGNED_TYPE | FLOATING_POINT_TYPE | CHAR_TYPE | FLINK_TYPE | VARSIZED_TYPE | GERMAN_VARSIZED_TYPE | DICTIONARY_TYPE | BOOLEAN_TYPE;
...
GERMAN_VARSIZED_TYPE: 'GERMAN_VARSIZED';
