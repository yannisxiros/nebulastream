...
class InlineEmitPhysicalOperator final : public PhysicalOperatorConcept
{
public:
    explicit InlineEmitPhysicalOperator(OperatorHandlerId operatorHandlerId, std::shared_ptr<TupleBufferRef> bufferRef);
