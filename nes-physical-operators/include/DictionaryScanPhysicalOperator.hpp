...
class DictionaryScanPhysicalOperator final : public PhysicalOperatorConcept
{
public:
    explicit DictionaryScanPhysicalOperator(std::shared_ptr<TupleBufferRef> bufferRef, std::vector<Record::RecordFieldIdentifier> projections);
