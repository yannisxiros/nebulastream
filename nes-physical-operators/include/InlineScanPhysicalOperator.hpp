...
class InlineScanPhysicalOperator final : public PhysicalOperatorConcept
{
public:
    explicit InlineScanPhysicalOperator(std::shared_ptr<TupleBufferRef> bufferRef, std::vector<Record::RecordFieldIdentifier> projections);
